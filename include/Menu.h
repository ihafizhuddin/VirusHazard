...
#define FONTSIZE 40
#define FONTNAME "kenvector_future.ttf"
#define NUM_BUTTON 5
...
private:
	...
	Mix_Music* menuClickSound = NULL;
	Mix_Music* gameClickSound = NULL;
	Mix_Music* switchSound = NULL;
	Mix_Music* matchSound = NULL;
	Mix_Music* moveSound = NULL;
